/**
 * Em um plano cartesiano, um c�rculo pode ser definido pelas coordenadas do centro e pelo raio, 
 * enquanto um ret�ngulo de lados paralelos aos eixos pode ser definido pelas coordenadas dos 
 * v�rtices superior esquerdo e inferior direito. Escreva um programa que leia os valores que definem 
 * um ret�ngulo e um c�rculo, e verifique qual tem o maior per�metro e qual tem a maior �rea.
 */
